...
export const videos = [
  {
    id: 'abc',
    title: 'ABC for Kids',
    description: 'Sing and learn the alphabet from A to Z.',
    duration: '4:20',
    emoji: '🔤',
  ...
  },
  {
    id: 'fruits',
    title: 'Learn Fruits',
    description: 'Discover yummy fruit names with bright pictures.',
    duration: '3:45',
    emoji: '🍎',
  ...
  },
  {
    id: 'animals',
    title: 'Learn Animals',
    description: 'Meet friendly animals and hear their sounds.',
    duration: '5:10',
    emoji: '🐶',
    gradient: 'from-sun to-mint',
  },
  {
    id: 'colors',
    title: 'Learn Colors',
    description: 'Find colors everywhere in the world around us.',
    duration: '3:30',
    emoji: '🎨',
  ...
  },
  {
    id: 'numbers',
    title: 'Learn Numbers',
    description: 'Count from 1 to 20 with fun songs and games.',
    duration: '4:55',
    emoji: '🔢',
